...
I must note that while the original request to somehow highlight OA materials in our catalog originally came from a faculty member, the idea to directly query and link to DOAJ/DOAB came from the [Open Library Badge](https://badge.openbiblio.eu) initiative.
